  ...
  return (
    <div>
      <div className='flex justify-between items-center p-6 font-poppins h-16 relative gap-2'>
        ...
        {menu && (
          <div className='absolute px-3 py-2 top-[4rem] right-[0] flex flex-col bg-white w-[50vw] max-w-[15rem] md:w-48 z-40 gap-4 justify-between rounded-b h-[calc(100vh-4rem)] md:h-auto'>
