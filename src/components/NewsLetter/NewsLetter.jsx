...
const NewsLetter = () => {
  return (
    <form onSubmit={(e) => e.preventDefault()} className="flex flex-col gap-6 items-center p-8 bg-[#EBF2EB] w-full relative overflow-hidden">
      ...
      <Button content={"Subscribe"} type={"submit"} className='z-20' />
